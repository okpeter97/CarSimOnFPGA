...
// ==============================================================
#ifndef __top_level_wheelSivdy__HH__
#define __top_level_wheelSivdy__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheelSivdy) {
    ...
    SC_CTOR(top_level_wheelSivdy):  ACMP_fpext_U ("ACMP_fpext_U") {
