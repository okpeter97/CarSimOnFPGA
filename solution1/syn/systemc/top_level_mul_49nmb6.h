...
// ==============================================================
#ifndef __top_level_mul_49nmb6__HH__
#define __top_level_mul_49nmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mul_49nmb6) {
    ...
    SC_CTOR(top_level_mul_49nmb6):  ACMP_mul_us_U ("ACMP_mul_us_U") {
