...
// ==============================================================
#ifndef __top_level_wheelSiyd2__HH__
#define __top_level_wheelSiyd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheelSiyd2) {
    ...
    SC_CTOR(top_level_wheelSiyd2):  ACMP_dadddsub_U ("ACMP_dadddsub_U") {
