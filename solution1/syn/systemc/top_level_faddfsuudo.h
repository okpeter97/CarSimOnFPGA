...
// ==============================================================
#ifndef __top_level_faddfsuudo__HH__
#define __top_level_faddfsuudo__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_faddfsuudo) {
    ...
    SC_CTOR(top_level_faddfsuudo):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
