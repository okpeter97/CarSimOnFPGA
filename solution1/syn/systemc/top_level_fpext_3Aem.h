...
// ==============================================================
#ifndef __top_level_fpext_3Aem__HH__
#define __top_level_fpext_3Aem__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_fpext_3Aem) {
    ...
    SC_CTOR(top_level_fpext_3Aem):  ACMP_fpext_U ("ACMP_fpext_U") {
