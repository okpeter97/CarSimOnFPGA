...
// ==============================================================
#ifndef __top_level_fcmp_32bkb__HH__
#define __top_level_fcmp_32bkb__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_fcmp_32bkb) {
    ...
    SC_CTOR(top_level_fcmp_32bkb):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
