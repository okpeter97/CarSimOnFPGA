...
// ==============================================================
#ifndef __top_level_wheelSiudo__HH__
#define __top_level_wheelSiudo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheelSiudo) {
    ...
    SC_CTOR(top_level_wheelSiudo):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
