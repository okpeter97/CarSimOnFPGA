...
// ==============================================================
#ifndef __top_level_sitofp_yd2__HH__
#define __top_level_sitofp_yd2__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_sitofp_yd2) {
    ...
    SC_CTOR(top_level_sitofp_yd2):  ACMP_sitofp_U ("ACMP_sitofp_U") {
