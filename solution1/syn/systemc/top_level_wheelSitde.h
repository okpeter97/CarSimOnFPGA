...
// ==============================================================
#ifndef __top_level_wheelSitde__HH__
#define __top_level_wheelSitde__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheelSitde) {
    ...
    SC_CTOR(top_level_wheelSitde):  ACMP_sitofp_U ("ACMP_sitofp_U") {
