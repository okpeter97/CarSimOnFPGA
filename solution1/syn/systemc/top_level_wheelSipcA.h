...
// ==============================================================
#ifndef __top_level_wheelSipcA__HH__
#define __top_level_wheelSipcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheelSipcA) {
    ...
    SC_CTOR(top_level_wheelSipcA):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
