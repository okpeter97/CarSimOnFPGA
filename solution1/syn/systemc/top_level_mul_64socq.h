...
// ==============================================================
#ifndef __top_level_mul_64socq__HH__
#define __top_level_mul_64socq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mul_64socq) {
    ...
    SC_CTOR(top_level_mul_64socq):  ACMP_mul_su_U ("ACMP_mul_su_U") {
