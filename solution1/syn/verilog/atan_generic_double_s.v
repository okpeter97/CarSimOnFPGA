...
wire   [0:0] tmp_63_fu_349_p3;
reg   [0:0] tmp_63_reg_825;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        ...
        tmp_69_reg_894 <= m_1_fu_693_p2[32'd54];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        ...
        tmp_63_reg_825 <= p_Val2_28_reg_159[32'd87];
...
assign icmp_ln851_fu_557_p2 = (($signed(tmp_67_fu_547_p4) > $signed(31'd0)) ? 1'b1 : 1'b0);
...
assign select_ln869_fu_720_p3 = ((tmp_69_reg_894[0:0] === 1'b1) ? 11'd1023 : 11'd1022);
...
assign tmp_63_fu_349_p3 = p_Val2_28_reg_159[32'd87];

assign tmp_64_fu_375_p3 = p_Val2_28_reg_159[32'd87];

assign tmp_65_fu_411_p3 = cordic_ctab_table_12_q0[32'd40];

assign tmp_67_fu_547_p4 = {{lsb_index_fu_541_p2[31:1]}};

assign tmp_68_fu_600_p3 = lsb_index_fu_541_p2[32'd31];
...
assign tx_V_fu_367_p3 = ((tmp_63_fu_349_p3[0:0] === 1'b1) ? sub_ln130_fu_357_p2 : add_ln130_fu_362_p2);

assign ty_V_fu_393_p3 = ((tmp_64_fu_375_p3[0:0] === 1'b1) ? add_ln130_1_fu_388_p2 : sub_ln130_1_fu_383_p2);

assign tz_V_fu_444_p3 = ((tmp_63_reg_825[0:0] === 1'b1) ? sub_ln130_2_fu_432_p2 : add_ln130_2_fu_438_p2);

assign xor_ln853_fu_608_p2 = (tmp_68_fu_600_p3 ^ 1'd1);
...
assign zext_ln369_fu_419_p1 = tmp_65_fu_411_p3;
