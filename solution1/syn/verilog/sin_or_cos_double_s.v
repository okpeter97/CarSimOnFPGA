...
reg   [36:0] tmp_45_reg_1316;
wire    ap_CS_fsm_state9;
reg   [28:0] tmp_46_reg_1321;
...
top_level_wheelSiibs #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 170 ),
    .din1_WIDTH( 53 ),
    .dout_WIDTH( 223 ))
top_level_wheelSiibs_U6(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(grp_fu_372_p0),
    .din1(grp_fu_372_p1),
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        ...
        tmp_45_reg_1316 <= {{r_V_26_fu_758_p2[74:38]}};
        tmp_46_reg_1321 <= {{r_V_27_fu_781_p2[59:31]}};
    end
end
...
assign zext_ln657_1_fu_845_p1 = tmp_46_reg_1321;

assign zext_ln657_fu_837_p1 = tmp_45_reg_1316;
