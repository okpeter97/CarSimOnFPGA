...
architecture behav of sin_or_cos_double_s is 
    ...
    signal tmp_6_fu_917_p18 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_7_fu_955_p18 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state16)) then
                ...
                tmp_9_reg_1378 <= r_V_27_fu_762_p2(59 downto 31);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state17)) then
                tmp_8_reg_1388 <= grp_fu_750_p2(74 downto 38);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    select_ln271_fu_993_p3 <= 
        tmp_6_fu_917_p18 when (cos_basis_reg_1393(0) = '1') else 
        tmp_7_fu_955_p18;
    ...
    zext_ln657_1_fu_829_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_9_reg_1378),64));
    zext_ln657_fu_821_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_8_reg_1388),64));
