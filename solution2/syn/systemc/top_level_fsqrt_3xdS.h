...
// ==============================================================
#ifndef __top_level_fsqrt_3xdS__HH__
#define __top_level_fsqrt_3xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_fsqrt_3xdS) {
    ...
    SC_CTOR(top_level_fsqrt_3xdS):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
