...
// ==============================================================
#ifndef __top_level_wheel_stde__HH__
#define __top_level_wheel_stde__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheel_stde) {
    ...
    SC_CTOR(top_level_wheel_stde):  ACMP_sitofp_U ("ACMP_sitofp_U") {
