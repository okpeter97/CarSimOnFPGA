...
// ==============================================================
#ifndef __top_level_mul_170ibs__HH__
#define __top_level_mul_170ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_mul_170ibs) {
    ...
    SC_CTOR(top_level_mul_170ibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
