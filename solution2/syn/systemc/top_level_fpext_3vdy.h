...
// ==============================================================
#ifndef __top_level_fpext_3vdy__HH__
#define __top_level_fpext_3vdy__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_fpext_3vdy) {
    ...
    SC_CTOR(top_level_fpext_3vdy):  ACMP_fpext_U ("ACMP_fpext_U") {
