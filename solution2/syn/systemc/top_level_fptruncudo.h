...
// ==============================================================
#ifndef __top_level_fptruncudo__HH__
#define __top_level_fptruncudo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_fptruncudo) {
    ...
    SC_CTOR(top_level_fptruncudo):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
