...
// ==============================================================
#ifndef __top_level_wheel_fvdy__HH__
#define __top_level_wheel_fvdy__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheel_fvdy) {
    ...
    SC_CTOR(top_level_wheel_fvdy):  ACMP_fpext_U ("ACMP_fpext_U") {
