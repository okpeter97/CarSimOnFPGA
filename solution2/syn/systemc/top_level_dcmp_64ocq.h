...
// ==============================================================
#ifndef __top_level_dcmp_64ocq__HH__
#define __top_level_dcmp_64ocq__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_dcmp_64ocq) {
    ...
    SC_CTOR(top_level_dcmp_64ocq):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
