...
// ==============================================================
#ifndef __top_level_faddfsupcA__HH__
#define __top_level_faddfsupcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_faddfsupcA) {
    ...
    SC_CTOR(top_level_faddfsupcA):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
