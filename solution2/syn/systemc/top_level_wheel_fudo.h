...
// ==============================================================
#ifndef __top_level_wheel_fudo__HH__
#define __top_level_wheel_fudo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheel_fudo) {
    ...
    SC_CTOR(top_level_wheel_fudo):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
