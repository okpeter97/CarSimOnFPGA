...
// ==============================================================
#ifndef __top_level_wheel_mibs__HH__
#define __top_level_wheel_mibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheel_mibs) {
    ...
    SC_CTOR(top_level_wheel_mibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
