...
// ==============================================================
#ifndef __top_level_wheel_fxdS__HH__
#define __top_level_wheel_fxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_wheel_fxdS) {
    ...
    SC_CTOR(top_level_wheel_fxdS):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
