...
// ==============================================================
#ifndef __top_level_car_sittde__HH__
#define __top_level_car_sittde__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_sittde) {
    ...
    SC_CTOR(top_level_car_sittde):  ACMP_sitofp_U ("ACMP_sitofp_U") {
