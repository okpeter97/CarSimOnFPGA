...
// ==============================================================
#ifndef __top_level_car_fsqxdS__HH__
#define __top_level_car_fsqxdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_fsqxdS) {
    ...
    SC_CTOR(top_level_car_fsqxdS):  ACMP_fsqrt_U ("ACMP_fsqrt_U") {
