...
// ==============================================================
#ifndef __top_level_car_fpevdy__HH__
#define __top_level_car_fpevdy__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_fpevdy) {
    ...
    SC_CTOR(top_level_car_fpevdy):  ACMP_fpext_U ("ACMP_fpext_U") {
