...
// ==============================================================
#ifndef __top_level_car_dcmocq__HH__
#define __top_level_car_dcmocq__HH__
#include "ACMP_dcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_dcmocq) {
    ...
    SC_CTOR(top_level_car_dcmocq):  ACMP_dcmp_U ("ACMP_dcmp_U") {
        ACMP_dcmp_U.clk(clk);
