...
// ==============================================================
#ifndef __top_level_car_fadpcA__HH__
#define __top_level_car_fadpcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_fadpcA) {
    ...
    SC_CTOR(top_level_car_fadpcA):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
