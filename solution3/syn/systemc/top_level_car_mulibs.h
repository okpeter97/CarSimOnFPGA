...
// ==============================================================
#ifndef __top_level_car_mulibs__HH__
#define __top_level_car_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_mulibs) {
    ...
    SC_CTOR(top_level_car_mulibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
