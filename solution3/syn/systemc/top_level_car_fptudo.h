...
// ==============================================================
#ifndef __top_level_car_fptudo__HH__
#define __top_level_car_fptudo__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_level_car_fptudo) {
    ...
    SC_CTOR(top_level_car_fptudo):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
